        ...
        <nav className="hidden md:block w-1/2">
          <ul className="flex justify-end items-center space-x-4">
            <li className="inline-block hover:underline hover:underline-offset-8">
              <Link to="/overview">About me</Link>
            </li>
            <li className="inline-block p-2 cursor-pointer">
              <a
                href="https://www.linkedin.com/in/ishan28mkip"
                target="_blank"
              >
            ...
            <li>
              <Link to="/components/urbancompany">
              ...
              <div className="pb-4">
                <li className="inline-block cursor-pointer">
                  <a
                    ...
                    target="_blank"
                  >
                    <img src={LinkedinIcon} alt="github" className="w-10 h-10" />
                  </a>
                </li>
              </div>
            </ul>
